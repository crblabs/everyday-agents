...
| Routine | One line |
|---|---|
| [📥 Email triage](email-triage/ABOUT.md) | Sorts new inbox mail into your labels, daily |
| [🧹 Email cleanup](email-cleanup/ABOUT.md) | Archives stale low-priority mail (never deletes) |
| [✉️ Reply radar](reply-radar/ABOUT.md) | The short daily list of emails that need an answer from you |
| [☕ Morning brief](morning-brief/ABOUT.md) | Your day on one phone screen, before you're up |
| [🗓 Week ahead](week-ahead/ABOUT.md) | Sunday lookahead: commitments, conflicts, things to prepare |
